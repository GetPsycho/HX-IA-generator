...
| Ampli | Notes |
|---|---|
| Mesa Boogie Electra Dyne | Principal sur Superunknown. Gain élevé, son épais et saturé. |
| Mesa Boogie Trem-o-Verb | Secondaire. |
| Marshall JMP | Également utilisé. |

**Réglages Marshall JMP (référence Black Hole Sun) :**
- Presence : 4 | Bass : 7 | Middle : 6 | Treble : 5 | Master : 6 | Gain : 7

Enceintes : 4×12 avec Celestion Vintage 30.

## Pédales (ère Superunknown)
...
| Boss CE-2 Chorus | Shimmer sur parties claires |
| CAE Line Driver | Always-on, boost d'entrée pour le Boogie |
| EHX Micro POG | Octave (usage ponctuel) |
| Dunlop Cry Baby Wah | Solos expressifs |
...
| Like Suicide | Clean + modulation + delay |
...
- https://www.guitarchalk.com/amp-settings-black-hole-sun-soundgarden/
- https://www.guitarchalk.com/soundgarden-kim-thayil-amp-settings/
- https://musicstrive.com/soundgarden-guitar-tone/
- https://equipboard.com/pros/kim-thayil
- https://equipboard.com/albums/soundgarden-superunknown-super-deluxe

...
| **Mesa Boogie Dual Rectifier** (canal Modern, Gain 7+) | KWB | `HD2_DistKWB` | Saturation haute-gain très serrée, caractère métal moderne. EQ neutre (Bass=0.0, Treble=0.0). Gain=0.78. Gain stacking : Scream808 (TS9, Gain=0.65) en amont resserre les palm mutes via mid hump 723 Hz. | How You Remind Me — Ryan Peake ; I'm Picky — Cyril Roger "CC" (Shaka Ponk) |
